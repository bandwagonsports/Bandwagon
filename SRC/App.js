...
const LEAGUE_META = {
  NFL:  { leagueId: "1",   season: "2024" },
  NBA:  { leagueId: "12",  season: "2024-2025" },
  MLB:  { leagueId: "1",   season: "2025" },
  NHL:  { leagueId: "57",  season: "2024" },
  FIFA: { leagueId: "1",   season: "2025" }, // FIFA World Cup league ID
};

const TEAMS = {
  NFL: [
    { id: "134937", name: "Eagles",   city: "Philadelphia",  color: "#004C54", accent: "#A5ACAF" },
    { id: "134919", name: "Cowboys",  city: "Dallas",        color: "#003594", accent: "#869397" },
    { id: "134920", name: "Chiefs",   city: "Kansas City",   color: "#E31837", accent: "#FFB81C" },
    { id: "134922", name: "49ers",    city: "San Francisco", color: "#AA0000", accent: "#B3995D" },
    { id: "134925", name: "Packers",  city: "Green Bay",     color: "#203731", accent: "#FFB612" },
    { id: "134918", name: "Bills",    city: "Buffalo",       color: "#00338D", accent: "#C60C30" },
    { id: "134930", name: "Patriots", city: "New England",   color: "#002244", accent: "#C60C30" },
    { id: "134931", name: "Giants",   city: "NY Giants",     color: "#0B2265", accent: "#A71930" },
  ],
  NBA: [
    { id: "134880", name: "Lakers",   city: "Los Angeles",   color: "#552583", accent: "#FDB927" },
    ...
    { id: "134870", name: "76ers",    city: "Philadelphia",  color: "#006BB6", accent: "#F58426" },
    { id: "134875", name: "Heat",     city: "Miami",         color: "#98002E", accent: "#F9A01B" },
    { id: "134855", name: "Bulls",    city: "Chicago",       color: "#CE1141", accent: "#cccccc" },
    { id: "134856", name: "Nuggets",  city: "Denver",        color: "#0E2240", accent: "#FEC524" },
    { id: "134885", name: "Bucks",    city: "Milwaukee",     color: "#00471B", accent: "#EEE1C6" },
  ],
  MLB: [
    { id: "134958", name: "Yankees",  city: "New York",      color: "#003087", accent: "#E4002C" },
    { id: "134956", name: "Red Sox",  city: "Boston",        color: "#BD3039", accent: "#aaaaaa" },
    { id: "134969", name: "Dodgers",  city: "Los Angeles",   color: "#005A9C", accent: "#EF3E42" },
    { id: "134960", name: "Astros",   city: "Houston",       color: "#002D62", accent: "#EB6E1F" },
    { id: "134953", name: "Braves",   city: "Atlanta",       color: "#CE1141", accent: "#aaaaaa" },
    { id: "134957", name: "Cubs",     city: "Chicago",       color: "#0E3386", accent: "#CC3433" },
    { id: "134962", name: "Phillies", city: "Philadelphia",  color: "#E81828", accent: "#002D72" },
    { id: "134972", name: "Giants",   city: "San Francisco", color: "#FD5A1E", accent: "#27251F" },
  ],
  NHL: [
    { id: "134830", name: "Bruins",      city: "Boston",     color: "#7a5c00", accent: "#FFB81C" },
    { id: "134845", name: "Rangers",     city: "New York",   color: "#0038A8", accent: "#CE1126" },
    { id: "134833", name: "Penguins",    city: "Pittsburgh", color: "#333333", accent: "#FCB514" },
    { id: "134850", name: "Maple Leafs", city: "Toronto",    color: "#003E7E", accent: "#aaccee" },
    { id: "134835", name: "Avalanche",   city: "Colorado",   color: "#6F263D", accent: "#aaaacc" },
    { id: "134837", name: "Red Wings",   city: "Detroit",    color: "#CE1126", accent: "#cccccc" },
  ],
  FIFA: [
    { id: "1",    name: "USA",       city: "Host Nation",   color: "#002868", accent: "#BF0A30" },
    { id: "6",    name: "Brazil",    city: "5x Champions",  color: "#009C3B", accent: "#FFDF00" },
    { id: "7",    name: "France",    city: "Defending",     color: "#002395", accent: "#ED2939" },
    { id: "9",    name: "Argentina", city: "2022 Champs",   color: "#74ACDF", accent: "#FFFFFF" },
    { id: "10",   name: "Germany",   city: "4x Champions",  color: "#000000", accent: "#DD0000" },
    { id: "760",  name: "Spain",     city: "La Roja",       color: "#AA151B", accent: "#F1BF00" },
    { id: "2",    name: "England",   city: "Three Lions",   color: "#012169", accent: "#FFFFFF" },
    { id: "16",   name: "Mexico",    city: "El Tri",        color: "#006847", accent: "#FFFFFF" },
  ],
};
